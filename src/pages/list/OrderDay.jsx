  ...
  const fetchData = async (courtID) => {
    if (courtID) {
      try {
        ...
        setData(response.data.filter((booking) => booking.bookingId)); // Ensure this is an array and filter non-recurring bookings
      } catch (error) {
      ...
      try {
        ...
        for (const court of courts) {
          ...
          allBookings.push(
            ...courtBookings.data.bookingResponseList.filter(
