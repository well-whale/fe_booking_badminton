          ...
          {userInfor && (
            <>
              {userInfor.role.roleID === 4 ? (
                <li className="link">
                  <NavLink to="/staff/home">Staff quản lí</NavLink>
                </li>
              ) : userInfor.role.roleID === 2 ? (
                <li className="link">
                  <NavLink to="/admin/home">Admin quản lí</NavLink>
                </li>
              ) : userInfor.role.roleID === 3 ? (
                <li className="link">
                  <NavLink to="/ownerCourt/home">Chủ sân quản lí</NavLink>
                </li>
              ) : (
                <li className="link">
                  <NavLink to="/booked">Lịch sử đặt</NavLink>
                </li>
              )}
            </>
          )}
